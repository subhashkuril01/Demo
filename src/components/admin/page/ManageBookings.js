        ...
        <section className="section-welcome bg1-pattern p-t-40 p-b-20">
          <div className="container-fluid">
            ...
            <div className="col-md-4 d-flex justify-content-around">
              <Link to={"/admin/approvedbookings"}><button className="btn btn-success">Approved Bookings</button></Link>
                  ...
                  <tbody>
                    {bookings?.map((i, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <button className="btn btn-success m-r-10" onClick={() => approveBooking(i.id)}>
